 ...
 */
export function extractFeatures(raw, { minN = 3, maxN = 5 } = {}) {
 ...
 */
export function buildVocabulary(documents, { minCount = 2, ...options } = {}) {
 ...
 */
export function vectorise(raw, vocabulary, options = {}) {
  const counts = new Map();
